  ...
  return (
    <section className="work-detail">
      { 
        ...
        <div href="https://calm.roycathey.org" target="_blank" className="work-detail__item">
          <img src="./images/cc.png" />
          <h1>Calm Corner is currently desktop only</h1>
        </div>
      }  
        <h1>Calm Corner</h1>
