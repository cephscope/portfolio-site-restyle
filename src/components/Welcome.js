    ...
    <div>
      <section>
        <div id="welcome">
          ...
          <h1>ROY CATHEY</h1>
          <p>I'm a front-end web developer. I like building applications on the internet that people actually enjoy using.</p>
          <div className="portrait">
            <p>For better or worse, I look like this: {`\xa0`}</p>
            <img src="./images/mesmall.jpeg" />
          </div>
          <p>I grew up on a farm in Texas, went to <a className="section-link" target="_blank" href="https://en.wikipedia.org/wiki/Hook_%27em_Horns">college in Austin</a>, and somehow managed to find my way to New York City. When I'm not writing code...</p>
